...
import { Building2, Search, MapPin, SlidersHorizontal } from 'lucide-react';
    ...
    <section className="bg-[#2D2D2D] pt-28 pb-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-[#F4D03F] text-xs font-black uppercase tracking-[0.3em]">Browse PGs</span>
        </div>
        
        <h1 className="text-5xl md:text-6xl font-black text-white uppercase tracking-tight mb-4">
          Find Your <span className="text-[#F4D03F]">Perfect PG</span>
        </h1>
        <p className="text-[#999] text-lg max-w-2xl mb-10 font-medium">
          Browse 800+ verified paying guest accommodations. Get exclusive deals on rent, food, and deposit when you book through studentsathi.
        </p>
