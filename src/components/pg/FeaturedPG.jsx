...
import { Building2, Star, MapPin, ArrowRight, BadgeCheck, TrendingUp, Wifi, Utensils, Shield, Wind, WashingMachine } from 'lucide-react';
    ...
    <section className="py-16 bg-[#F5F1EB]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl font-black text-[#2D2D2D] uppercase tracking-tight">PG of the Month</h2>
        </div>
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="bg-[#C41E3A]/10 h-80 lg:h-auto relative flex items-center justify-center border-b-2 lg:border-b-0 lg:border-r-2 border-[#2D2D2D]">
              <div className="bg-[#F5F1EB] p-10 border-4 border-[#2D2D2D] shadow-[6px_6px_0px_0px_#000]">
                <Building2 className="w-16 h-16 text-[#C41E3A]" />
              </div>
            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="flex items-center gap-2 text-[#999] mb-6">
                ...
                <span className="text-sm font-medium">Indiranagar 12th Main, Bangalore - 0.5 km from college</span>
              </div>
              ...
              <div className="flex items-center gap-6 mb-8">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-[#666] text-sm">(389 reviews)</span>
                </div>
                <div className="w-px h-6 bg-[#444]"></div>
                <span className="text-[#999] text-sm font-medium">Girls PG</span>
                <div className="w-px h-6 bg-[#444]"></div>
                <span className="text-[#999] text-sm font-medium">4 rooms left</span>
              </div>

              {/* Amenities */}
              <div className="flex flex-wrap gap-3 mb-8">
                {['WiFi', 'Food', 'Security', 'AC', 'Laundry'].map((amenity) => (
                  <span key={amenity} className="bg-white/10 border border-white/20 text-white px-3 py-1.5 text-xs font-bold uppercase flex items-center gap-1">
                    ...
                    {amenity === 'Laundry' && <WashingMachine className="w-3 h-3" />}
                    {amenity}
                  </span>
                ))}
              </div>
              ...
              <div className="bg-[#F4D03F]/10 border border-[#F4D03F]/30 p-6 mb-8">
                <div className="flex items-end justify-between mb-2">
                  <div>
                    <p className="text-[#999] text-sm line-through font-bold">Market Rent: ₹16,000/mo</p>
                    <p className="text-4xl font-black text-[#F4D03F]">₹14,000<span className="text-lg">/mo</span></p>
                  </div>
                ...
                <p className="text-[#F4D03F]/70 text-xs font-bold uppercase tracking-wide">That's ₹24,000 saved in a year!</p>
              </div>
