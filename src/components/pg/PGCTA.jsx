...
import { Phone, Mail, MessageCircle, ArrowRight, Building2 } from 'lucide-react';

const PGCTA = () => {
  return (
    <section className="py-20 bg-[#2D2D2D] relative overflow-hidden border-t-2 border-[#444]">
      <div className="absolute top-10 left-10 w-32 h-32 bg-[#C41E3A] opacity-10 rotate-12"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tight mb-6 leading-tight">
              Can't Find the<br />Right PG?
            </h2>
            <p className="text-[#999] text-lg mb-8 font-medium leading-relaxed">
              We personally visit every PG before listing. Tell us your budget and area, we'll find you the safest, most comfortable PG within 24 hours.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-3 bg-[#F5F1EB] px-5 py-3 border-2 border-[#2D2D2D] shadow-[4px_4px_0px_0px_#000]">
                ...
                <span className="text-sm font-black text-[#2D2D2D]">pg@studentsathi.in</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F5F1EB] border-2 border-[#2D2D2D] p-8 shadow-[8px_8px_0px_0px_#000]">
            ...
            <div className="space-y-4">
              ...
              <button className="w-full bg-[#C41E3A] hover:bg-[#A01830] text-white py-4 font-black uppercase tracking-widest border-2 border-[#2D2D2D] shadow-[4px_4px_0px_0px_#2D2D2D] hover:shadow-[2px_2px_0px_0px_#2D2D2D] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex items-center justify-center gap-2">
                <MessageCircle className="w-5 h-5" />
                Request Callback
              </button>
            </div>
            <p className="text-[#666] text-xs mt-4 text-center font-medium">
              Our PG expert will call you within 24 hours
            </p>
          </div>
        </div>
      </div>
