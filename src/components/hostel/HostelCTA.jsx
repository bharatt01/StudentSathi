...
import { Phone, Mail, MessageCircle, ArrowRight, Home } from 'lucide-react';

const HostelCTA = () => {
  return (
    <section className="py-20 bg-[#2D2D2D] relative overflow-hidden border-t-2 border-[#444]">
      <div className="absolute top-10 left-10 w-32 h-32 bg-[#8B6914] opacity-10 rotate-12"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tight mb-6 leading-tight">
              Can't Find the<br />Right Hostel?
            </h2>
            <p className="text-[#999] text-lg mb-8 font-medium leading-relaxed">
              Our team personally visits every hostel before listing. Tell us your budget and college, we'll find you the perfect match within 24 hours.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-3 bg-[#F5F1EB] px-5 py-3 border-2 border-[#2D2D2D] shadow-[4px_4px_0px_0px_#000]">
                ...
                <span className="text-sm font-black text-[#2D2D2D]">hostels@studentsathi.in</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F5F1EB] border-2 border-[#2D2D2D] p-8 shadow-[8px_8px_0px_0px_#000]">
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-[#8B6914] p-2 border-2 border-[#2D2D2D]">
                <Home className="w-5 h-5 text-white" />
              </div>
              <h3 className="text-xl font-black text-[#2D2D2D] uppercase tracking-tight">
                Get Free Hostel Assistance
              </h3>
            </div>
            <div className="space-y-4">
              ...
              <select className="w-full px-5 py-4 bg-white border-2 border-[#2D2D2D] text-[#2D2D2D] text-sm font-bold focus:outline-none appearance-none cursor-pointer">
                ...
                <option>Under ₹8,000/mo</option>
                <option>₹8,000 - ₹12,000/mo</option>
                <option>₹12,000 - ₹16,000/mo</option>
                <option>Above ₹16,000/mo</option>
              </select>
              <button className="w-full bg-[#8B6914] hover:bg-[#6B5310] text-white py-4 font-black uppercase tracking-widest border-2 border-[#2D2D2D] shadow-[4px_4px_0px_0px_#2D2D2D] hover:shadow-[2px_2px_0px_0px_#2D2D2D] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex items-center justify-center gap-2">
                <MessageCircle className="w-5 h-5" />
                Request Callback
              </button>
            </div>
            <p className="text-[#666] text-xs mt-4 text-center font-medium">
              Our hostel expert will call you within 24 hours
            </p>
          </div>
        </div>
      </div>
