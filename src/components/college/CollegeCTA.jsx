        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tight mb-6 leading-tight">
              Confused Which College<br />to Choose?
            </h2>
            <p className="text-[#999] text-lg mb-8 font-medium leading-relaxed">
              Talk to our expert counselors for free. They'll help you find the best college based on your budget, location preference, and career goals.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-3 bg-[#F5F1EB] px-5 py-3 border-2 border-[#2D2D2D] shadow-[4px_4px_0px_0px_#000]">
                ...
                <span className="text-sm font-black text-[#2D2D2D]">help@studentsathi.in</span>
              </div>
            </div>
          </div>

          <div className="bg-[#F5F1EB] border-2 border-[#2D2D2D] p-8 shadow-[8px_8px_0px_0px_#000]">
            <h3 className="text-xl font-black text-[#2D2D2D] uppercase tracking-tight mb-6">
              Get Free Counseling
            </h3>
